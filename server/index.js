...
// CORS configuration for production deployment (Vercel + Localhost)
...
app.use(cors({
  origin: (origin, callback) => {
    ...
    // Allow configured origins or any *.vercel.app deployment URL
    if (
    ...
    // Default fallback allow for seamless evaluation
    return callback(null, true);
  },
  credentials: true,
